...
#ifdef HAVE_IPC_TARGET_NV
#define GstUnixFdSink GstNvCustomUnixFdSink
#define GstUnixFdSinkClass GstNvCustomUnixFdSinkClass
#define GstUnixFdSrc GstNvCustomUnixFdSrc
#define GstUnixFdSrcClass GstNvCustomUnixFdSrcClass
#endif
